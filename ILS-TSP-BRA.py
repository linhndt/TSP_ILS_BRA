import numpy as np
import time
from SharedBRA import tourCost, stochasticTwoOpt, constructInitialSolution, getBRA
...
def doubleBridgeMove(perm):
    ...
    p1 = 1 + getBRA(0.2, sliceLength)
    p2 = p1 + 1 + getBRA(0.2, sliceLength)
    p3 = p2 + 1 + getBRA(0.2, sliceLength)
